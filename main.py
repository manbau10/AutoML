...
st.set_page_config(page_title='Automatic Machine Learning App',
    layout='wide')
#---------------------------------#
# Model building
def build_model(df):
    ...
    st.markdown('**1.2. Dimension of the dataset**')
    st.write('X')
    st.info(X.shape)
    st.write('Y')
    st.info(Y.shape)

    st.markdown('**1.3. Details of the variables**:')
    ...
    st.subheader('3. Plot of Model Performance (Testing dataset)')
...
Streamline your machine learning model building process using the lazypredict library. 

On this website, you can simultaneously create multiple machine learning models and find the best performer for your task.

Developed by Ridwan Taiwo
